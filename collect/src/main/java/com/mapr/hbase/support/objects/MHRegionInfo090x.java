 ...
 */
public class MHRegionInfo090x extends VersionedWritable implements
    WritableComparable<MHRegionInfo090x>{
  private static final byte VERSION = 0;
  private static final Log LOG = LogFactory.getLog(MHRegionInfo090x.class);
  ...
  public static final MHRegionInfo090x ROOT_REGIONINFO =
    new MHRegionInfo090x(0L, HTableDescriptor.ROOT_TABLEDESC);

  /** HRegionInfo for first meta region */
  public static final MHRegionInfo090x FIRST_META_REGIONINFO =
    new MHRegionInfo090x(1L, HTableDescriptor.META_TABLEDESC);
   ...
   * first meta regions
   */
  private MHRegionInfo090x(long regionId, HTableDescriptor tableDesc) {
    super();
   ...
   */
  public MHRegionInfo090x(final HTableDescriptor tableDesc, final byte[] startKey,
                         final byte[] endKey)
  throws IllegalArgumentException {
   ...
   * @throws IllegalArgumentException
   */
  public MHRegionInfo090x(HTableDescriptor tableDesc, final byte[] startKey,
   ...
   * @param other
   */
  public MHRegionInfo090x(MHRegionInfo090x other) {
    super();
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MHRegionInfo090x)) {
      return false;
    }
    return this.compareTo((MHRegionInfo090x)o) == 0;
  }
  ...
  public int compareTo(MHRegionInfo090x o) {
    if (o == null) {
      return 1;
    }
