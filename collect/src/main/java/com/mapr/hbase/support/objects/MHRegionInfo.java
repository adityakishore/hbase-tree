 ...
 */
package com.mapr.hbase.support.objects;
 ...
 */
public class MHRegionInfo extends VersionedWritable
implements WritableComparable<MHRegionInfo> {
  ...
  private static final Log LOG = LogFactory.getLog(MHRegionInfo.class);
  ...
  public static final MHRegionInfo ROOT_REGIONINFO =
    new MHRegionInfo(0L, Bytes.toBytes("-ROOT-"));

  /** HRegionInfo for first meta region */
  public static final MHRegionInfo FIRST_META_REGIONINFO =
    new MHRegionInfo(1L, Bytes.toBytes(".META."));
   ...
   * first meta regions
   */
  private MHRegionInfo(long regionId, byte[] tableName) {
    super();
   ...
   */
  public MHRegionInfo(MHRegionInfo090x other) {
    super();
  ...
  public MHRegionInfo(final byte[] tableName) {
   ...
   */
  public MHRegionInfo(final byte[] tableName, final byte[] startKey,
                     final byte[] endKey)
  throws IllegalArgumentException {
   ...
   * @param other
   */
  public MHRegionInfo(MHRegionInfo other) {
    super();
    this.endKey = other.getEndKey();
    this.offLine = other.isOffline();
    this.regionId = other.getRegionId();
  ...
  public boolean isRootRegion() {
    return Bytes.equals(tableName, MHRegionInfo.ROOT_REGIONINFO.getTableName());
  }
  ...
  public boolean isMetaRegion() {
     return Bytes.equals(tableName, MHRegionInfo.FIRST_META_REGIONINFO.getTableName());
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof MHRegionInfo)) {
      return false;
    }
    return this.compareTo((MHRegionInfo)o) == 0;
  }
  ...
  public int compareTo(MHRegionInfo o) {
    if (o == null) {
      return 1;
    }
